...
#Copy the script to your server: wget odoo16.sh
#Make the script executable: chmod +x install_odoo16.sh
#Run the script: sudo ./install_odoo16.sh
...
#aqui abajo los addons de Cybro (vamo a probar)
